          ...
          <form>
            ...
            <div className="relative mb-[20px]">
              <input
                type="text"
                required
                className="focus:border-gray-400 focus:outline-none text-[14px] border shadow-sm rounded-xl mt-[12px] pl-[16px] py-[14px] pr-[20px] w-full dark:bg-[#1f2a45] dark:border-gray-600 dark:text-white"
            ...
            <div className="mt-4 mb-4 flex border border-gray-200 dark:border-gray-600 py-6 rounded-xl justify-center items-center flex-col cursor-pointer relative dark:bg-[#1f2a45]">
              <input
                type="file"
            ...
            <textarea
              className="w-full h-[150px] focus:border-gray-400 rounded-[16px] mb-[100px] outline-none mt-4 px-[20px] font-urbanist py-[14px] text-[14px] font-semibold text-gray-700 dark:text-white dark:bg-[#1f2a45] border border-gray-200 dark:border-gray-600"
