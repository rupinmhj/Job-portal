        ...
        <div className="mt-[24px]">
            <div className="flex gap-[12px] items-center mb-[16px]">
                ...
                <div className="flex w-full justify-between items-center">
                    ...
                    <h1 className=' text-[#12192799] dark:text-white text-[14px] leading-[24px] font-medium'>www.google.com</h1>
                </div>
            </div>
            <div className="flex gap-[12px] items-center mb-[16px]">
                ...
                <div className="flex w-full justify-between items-center">
                    ...
                    <h1 className=' text-[#12192799] dark:text-white text-[14px] leading-[24px] font-medium'>California, USA</h1>
                </div>
            </div>
            <div className="flex gap-[12px] items-center mb-[16px]">
                ...
                <div className="flex w-full justify-between items-center">
                    ...
                    <h1 className=' text-[#12192799] dark:text-white  text-[14px] leading-[24px] font-medium'>September 4, 1998</h1>
                </div>
            </div>
            <div className="flex gap-[12px] items-center mb-[16px]">
                ...
                <div className="flex w-full justify-between items-center">
                    ...
                    <h1 className=' text-[#12192799] dark:text-white text-[14px] leading-[24px] font-medium'>100,000 Employee</h1>
                </div>
            </div>
            <div className="flex gap-[12px] items-center mb-[16px]">
                ...
                <div className="flex w-full justify-between items-center">
                    ...
                    <h1 className=' text-[#12192799] dark:text-white text-[14px] leading-[24px] font-medium'>$25,000 Billion</h1>
                </div>
            </div>
