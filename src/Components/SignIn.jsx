...
const SignIn = () => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await apiPublic.post("/accounts/login/", {
        email,
        password,
          ...
          <form onSubmit={handleSignIn}>
            <div className="mt-[32px] w-full flex flex-col">
              ...
              <div className="relative mb-[20px]">
                ...
                />
                {emailError && (
                  <p className="text-red-600 text-[12px] pl-4">{emailError}</p>
                )}
              </div>
            </div>
            ...
            <div className="mt-[10px] w-full flex flex-col">
              ...
              <div className="relative mb-[20px]">
                <img
                  src={images.password}
                  className="dark:invert absolute z-20 inset-y-7 size-[20px] left-4"
                  alt="Password"
                />
                ...
                {passwordError && (
                  <p className="text-red-600 text-[12px] pl-4">{passwordError}</p>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 mb-[20px]">
                ...
                <label
                  ...
                  className="text-sm text-[#71757D] dark:text-gray-400"
                >
                  Remember me
                </label>
              </div>
