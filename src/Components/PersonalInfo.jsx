    ...
    <div className="bg-white lg:px-[232px] font-urbanist text-[rgb(18, 25, 39)] w-full">
      <div className="fixed top-0 left-0 right-0 bg-white z-10">
        <div className="flex items-center justify-between px-[24px] lg:px-[252px] py-[16px]">
          ...
          <img src={images.home} className="cursor-pointer" onClick={()=>navigate('/home')} alt="" />
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative mb-[8px]">
            ...
            <input
              ...
              className={`focus:outline-none border placeholder-black ${
                errors.fullName ? "border-red-500" : "border-gray-900"
          ...
          <div className="relative mb-[8px]">
            ...
            <input
              ...
              onChange={handleChange}
              className={`focus:outline-none border placeholder-black ${
                errors.contactNumber ? "border-red-500" : "border-gray-900"
          ...
          <div className="relative mb-[8px]">
            ...
            <input
              ...
              onChange={handleChange}
              className={`bg-white appearance-none focus:outline-none border placeholder-black ${
                errors.dateOfBirth ? "border-red-500" : "border-gray-900 "
              } shadow-sm rounded-xl mt-[12px] pl-[52px] py-[14px] border pr-[20px] w-full`}
            />
          ...
          <div className="relative mb-[8px] cursor-pointer" >
            ...
            <select
              ...
              onChange={handleChange}
              className={`appearance-none focus:outline-none border placeholder-black ${
                errors.gender ? "border-gray-900" : "border-gray-900"
