      ...
      <div className='w-full'>
        ...
        <div className="flex w-[100%] flex-wrap bg-bgColor pt-10 rounded-xl pb-20 ">
          ...
          <div onClick={()=>navigate('/createjob')} className=" flex justify-center flex-1 flex-col items-center gap-[8px] w-1/4 ">
            <img src={images.createjob} className="cursor-pointer hover:border-blue-500   transition-all duration-300 hover:shadow-sm  size-[65.6px] border-2 border-gray-200 p-[9px] rounded-lg" alt="" />
          ...
          <div onClick={()=>navigate('/managejob')} className=" flex justify-center flex-1 flex-col items-center gap-[8px] w-1/4 ">
            <img src={images.managejob} className="cursor-pointer hover:border-blue-500   transition-all duration-300 hover:shadow-sm  size-[65.6px] border-2 border-gray-200 p-[9px] rounded-lg" alt="" />
