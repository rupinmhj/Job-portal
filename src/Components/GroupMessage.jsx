      ...
      <div className="p-[24px] pb-[94px] pt-[108px] max-w-[1024px] mx-auto">
        ...
        <div className="flex flex-col w-full items-end mb-5">
          ...
          <div className="flex felx-col gap-2">
            <img src={images.messenger1} className=" h-[38.4px] w-[38.4px]  rounded-full border border-green-400" alt="" />
                  <div className="flex flex-col w-full items-start mb-5">
          <p className="flex gap-2 items-center ml-4 mb-[5px] text-[10px] font-medium leading-[12px] text-google">
            <span className="text-[12px] leading-[20px] font-semibold text-custBlackBold">Arijit Singh</span>
        ...
        <div className="flex flex-col w-full items-end mb-5">
          ...
          <div className="flex felx-col gap-2">
            <img src={images.messenger5} className=" h-[38.4px] w-[38.4px]  rounded-full border border-green-400" alt="" />
                  <div className="flex flex-col w-full items-start mb-5">
          <p className="flex gap-2 items-center ml-4 mb-[5px] text-[10px] font-medium leading-[12px] text-google">
            <span className="text-[12px] leading-[20px] font-semibold text-custBlackBold">Sonu Nigam</span>
            <span className="h-1 w-1 bg-orange-400 rounded-full"></span>
            <span>11:23 AM</span>
          </p>
          <span className="text-[12px] leading-[14px] font-medium  py-[14px] pr-[31px] pl-[16px] bg-white rounded-t-[100px] rounded-bl-[30px] rounded-br-[100px]">
