...
const Notification = () => {
  ...
  return (
    <div className="text-[rgb(18, 25, 39)] lg:px-[232px] xl:px-[274px] px-[24px] pt-[20px] pb-[24px] flex font-urbanist items-center justify-between">
    ...
    <div className="relative flex p-[16px] pr-[32px] mt-[59.6px] gap-[16px]">
      ...
      <img src={images.threeDot} className="absolute right-2 top-5 size-5" alt="" />
      </div>
